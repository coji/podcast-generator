/*
  ...
  - You are about to drop the column `audio_length` on the `episodes` table. All the data in the column will be lost.
  - You are about to drop the column `audio_type` on the `episodes` table. All the data in the column will be lost.
