...
INSERT INTO "new_episodes" ("audio_duration", "audio_url", "backgroundMusicId", "created_at", "description", "episode_number", "id", "image_url", "manuscript", "podcast_id", "published_at", "state", "title", "updated_at") SELECT "audio_duration", "audio_url", "backgroundMusicId", "created_at", "description", "episode_number", "id", "image_url", "manuscript", "podcast_id", "published_at", "state", "title", "updated_at" FROM "episodes";
DROP TABLE "episodes";
